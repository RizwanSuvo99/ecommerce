        ...
        <div className="relative z-10 space-y-6">
          <blockquote className="space-y-4">
            <p className="text-lg leading-relaxed text-primary-foreground/90">
              &ldquo;This platform has completely transformed how I shop online.
              The selection is incredible, the prices are unbeatable, and
              delivery is always lightning fast. I can&apos;t imagine going back
              to any other store.&rdquo;
            </p>
